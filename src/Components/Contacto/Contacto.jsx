...
function Contacto() {
  return (
    <section id="contacto" className="py-12 sm:py-16 md:py-20 bg-gradient-to-r from-[#020420] to-[#03072b] min-h-screen">
      <motion.h3 
        initial={{ opacity: 0, y: -20 }} // Estado inicial
        whileInView={{ opacity: 1, y: 0 }} // Animación cuando es visible
